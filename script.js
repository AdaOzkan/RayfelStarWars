// --- PASSWORDS ---
        ...
        // Extracted from the provided Star Wars Systems PDF
        const galacticDatabase = [
            ...
            // OTHERS CAN BE ADDED HERE EASILY FROM THE PDF
        ];
        ...
        function focusOnSystem(sys) {
            ...
            // Koordinat Dönüştürme Mantığı (A-X arası 24 Sütun, 1-22 arası Satır varsayımı)
            ...
            // Harita Katmanına Ping (Radar İşareti) Ekle
            ...
            // 6 Saniye Sonra İşareti Temizle
        ...
        function renderZones() {
            ...
            // Search Ping'i tutmak için (Çünkü zone-layer'ı temizliyoruz)
        ...
        function renderEntities() {
            ...
            let stats = {
                    sith: { base: 5, ship: 20, person: 12 },
                    jedi: { base: 5, ship: 20, person: 12 }
                };
        ...
        function initializeStartingForces() {
            ...
            // 12 Sith Personeli
            for(let i=1; i<=12; i++) {
                entities.push({ id: 'sith-p'+i, faction: 'sith', type: 'Person', name: 'Sith Trooper '+i, x: 100 + (i*20), y: 100, boardedIn: null });
            }
            // 12 Jedi Personeli
            for(let i=1; i<=12; i++) {
                entities.push({ id: 'jedi-p'+i, faction: 'jedi', type: 'Person', name: 'Jedi Knight '+i, x: 1800 - (i*20), y: 1800, boardedIn: null });
            }
